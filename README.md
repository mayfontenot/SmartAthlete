...
Installation: <br/>
1. Create a MySQL database called db_health_injuries
2. Import the included db_health_injuries.sql file
3. Configure the MySQLConnector in utilities.MySQLConnector to match your server, DEFAULT is (IP: localhost, port: 8889)
4. Build and deploy the WAR file to the web
